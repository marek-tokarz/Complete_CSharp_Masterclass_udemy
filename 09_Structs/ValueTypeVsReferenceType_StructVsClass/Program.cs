namespace ValueTypeVsReferenceType_StructVsClass
{
    public struct Point
    {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Point p2 = p1; // p2 is a copy of pi
            p2.Display();
